...
//			dispatcher.forward(request,response);
			...
			try {
				...
				connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/iotbay?useSSL=false","root","Ks180507");
...
//					request.setAttribute("status", "failed");
    ...
    private boolean emailExists(String email) {
        ...
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            connectEmail = DriverManager.getConnection("jdbc:mysql://localhost:3306/iotbay?useSSL=false","root","Ks180507");
